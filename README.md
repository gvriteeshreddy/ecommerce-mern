...
```bash
  git clone https://github.com/gvriteeshreddy/ecommerce-mern.git
```
...
- Github [@riteeshreddy](https://github.com/gvriteeshreddy)
- Linkedin [@riteesh-reddy](https://www.linkedin.com/in/riteeshreddy/)
